...
Output/table_1.rds: Data/cleaned_EC_data.RDS Code/01_table_1.R
	Rscript Code/01_table_1.R

# Code/02_table_2.R: create table 2
Output/table_2.rds: Data/cleaned_EC_data.RDS Code/02_table_2.R
	Rscript Code/02_table_2.R
	
# Code/03_table_3.R: create table 3
Output/table_3.rds: Data/cleaned_EC_data.RDS Code/03_table_3.R
	Rscript Code/03_table_3.R

# Code/04_figure_1.R: create figure 1
Output/figure_1.rds: Data/cleaned_EC_data.RDS Code/04_figure_1.R
